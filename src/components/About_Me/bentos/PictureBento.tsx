...
export function PictureBento() {
  return (
    <Card className='relative col-span-1 bg-gradient-to-b from-transparent to-slate-700/70 border border-slate-500 hover:border-slate-300 text-white hover:to-slate-600/70 transition-colors duration-300'>
