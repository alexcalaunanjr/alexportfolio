...
export function Footer() {
  ...
  return (
    <footer className='relative bg-black border-t border-slate-700/50 mt-20 w-full overflow-hidden'>
      <div className='flex items-start justify-between mx-auto px-6 md:px-20 py-12 w-full min-h-[200px]'>
        {/* LEFT SIDE */}
        <div className='flex flex-col justify-between h-full gap-4'>
          {/* top left: name and social links */}
          <div>
            <h3 className='font-bold text-lg animate-gradient-x mb-4'>
              Alex Calaunan Jr
            </h3>
        ...
        <div className='flex flex-col justify-between h-full'>
          ...
          {/* bottom right: empty div for alignment */}
          <div></div>
        </div>
      </div>
